 ...
 */
bool PPC::isVMRGINEhuffleMask(ShuffleVectorSDNode *N, bool CheckEven,
                              unsigned ShuffleKind, SelectionDAG &DAG) {
  if (DAG.getDataLayout().isLittleEndian()) {
...
SDValue PPCTargetLowering::LowerVECTOR_SHUFFLE(SDValue Op,
  ...
  if (V2.isUndef()) {
    if (PPC::isSplatShuffleMask(SVOp, 1) ||
        ...
        (Subtarget.hasP8Altivec() && (
         ...
         PPC::isVMRGINEhuffleMask(SVOp, true, 1, DAG) ||
         PPC::isVMRGINEhuffleMask(SVOp, false, 1, DAG)))) {
      return Op;
    }
  }
  ...
  if (PPC::isVPKUWUMShuffleMask(SVOp, ShuffleKind, DAG) ||
      ...
      (Subtarget.hasP8Altivec() && (
       ...
       PPC::isVMRGINEhuffleMask(SVOp, true, ShuffleKind, DAG) ||
       PPC::isVMRGINEhuffleMask(SVOp, false, ShuffleKind, DAG))))
    return Op;
