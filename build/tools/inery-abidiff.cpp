...
struct abidiff_exception : public std::exception {
   virtual const char* what() const throw() {
      return "inery.abidiff fatal error";
   }
} abidiff_ex;
...
int main(int argc, const char **argv) {
   ...
   cl::SetVersionPrinter([](llvm::raw_ostream& os) {
        os << "inery-abidiff version " << "1.7.0" << "\n";
  });
   cl::OptionCategory cat("inery-abidiff", "generates an abi from C++ project input");
   ...
   cl::ParseCommandLineOptions(argc, argv, std::string("inery-abidiff"));
   try {
