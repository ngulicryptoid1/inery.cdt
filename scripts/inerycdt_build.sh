...
if [ ! -d "${REPO_ROOT}/.git" ]; then
   ...
   printf "Please clone a new ine directory with 'git clone https://github.com/INERY/ine --recursive'\\n"
   printf "See the wiki for instructions: https://github.com/INERY/ine/wiki\\n"
   exit 1
fi
...
if [ "$ARCH" == "Linux" ]; then
   ...
   case "$OS_NAME" in
      "Amazon Linux AMI"|"Amazon Linux")
         FILE="./scripts/inerycdt_build_amazon.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "CentOS Linux")
         FILE="${REPO_ROOT}/scripts/inerycdt_build_centos.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "elementary OS")
         FILE="${REPO_ROOT}/scripts/inerycdt_build_ubuntu.sh"
         CXX_COMPILER=clang++-4.0
         C_COMPILER=clang-4.0
      ;;
      "Fedora")
         FILE="${REPO_ROOT}/scripts/inerycdt_build_fedora.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "Linux Mint")
...
if [ "$ARCH" == "Darwin" ]; then
   ...
   FILE="${REPO_ROOT}/scripts/inerycdt_build_darwin.sh"
...
printf "\\n========================================================================\\n"
printf "======================= Starting INERY.CDT Build =======================\\n"

$CMAKE -DCMAKE_INSTALL_PREFIX=$OPT_LOCATION/inery.cdt "${REPO_ROOT}"
...
printf "\\nINERY.CDT has been successfully built. %02d:%02d:%02d\\n\\n" $(($TIME_END/3600)) $(($TIME_END%3600/60)) $(($TIME_END%60))
printf "${txtrst}==============================================================================================\\n"

printf "For more information:\\n"
printf "INERY website: https://ine.io\\n"
printf "INERY Telegram channel @ https://t.me/INEProject\\n"
printf "INERY resources: https://ine.io/resources/\\n"
printf "INERY Stack Exchange: https://inery.stackexchange.com\\n"
printf "INERY wiki: https://github.com/INERY/ine/wiki\\n\\n\\n"
