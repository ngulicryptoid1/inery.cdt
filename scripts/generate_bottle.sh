...
mkdir -p ${PROJECT}/${VERSION}/opt/inery_cdt/lib/cmake
...
echo "class IneryCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/inery/inery.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/inery/inery.cdt/releases/download/v${VERSION}\"
