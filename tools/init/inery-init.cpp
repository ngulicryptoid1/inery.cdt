...
struct project {
   ...
   const std::string hpp = "#include <inery/inery.hpp>\n"
                           "using namespace inery;\n\n"
   ...
   const std::string readme_cmake = "--- @ Project ---\n\n"
                                    ...
                                    "   - You can then do a 'set contract' action with 'cline' and point in to the './build/@' directory\n\n"
                                    " - Additions to CMake should be done to the CMakeLists.txt in the './src' directory and not in the top level CMakeLists.txt";

   const std::string readme_bare = " --- @ Project ---\n\n"
                                   " - How to Build -\n"
                                   "   - run the command 'inery-cpp -abigen -o @.wasm @.cpp'\n";
...
int main(int argc, const char **argv) {
   ...
   cl::SetVersionPrinter([](llvm::raw_ostream& os) {
        os << "inery-init version " << "@VERSION_FULL@" << "\n";
  });
   cl::OptionCategory cat("inery-init", "generates an inery smart contract project");
   ...
   cl::ParseCommandLineOptions(argc, argv, std::string("inery-proj"));
   try {
