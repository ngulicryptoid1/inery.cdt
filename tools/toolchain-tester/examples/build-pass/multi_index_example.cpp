...
CONTRACT multi_index_example : public contract {
   public:
      ...
      typedef inery::multi_index<"testtaba"_n, test_table, inery::indexed_by<"secid"_n, inery::const_mem_fun<test_table, uint64_t, &test_table::by_secondary>>> test_tables;
