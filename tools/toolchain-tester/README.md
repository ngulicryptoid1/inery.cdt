...
```json
{
    "tests": [
        {
            "expected": {
                "stderr": "iostreams currently clash with inery::datastream"
            }
        }
    ]
}
...
```json
{
    "tests": [
        {
            "expected": {
                "abi": "{\"____comment\": \"This file was generated with inery-abigen. DO NOT EDIT\",\n\"version\": \"inery::abi/1.1\",\"types\": [],\"structs\": [..."
            }
        }
    ]
}
